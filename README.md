...
- One giant, bold word centered on the screen, sized to fill most of the screen width (responsive, huge on desktop, still readable on mobile): "NIGHT PULSE"
...
Continue developing this project in the [Lovable editor](https://lovable.dev/projects/cacc577e-352e-4ef2-8a1d-d8ab0d8177f3).
